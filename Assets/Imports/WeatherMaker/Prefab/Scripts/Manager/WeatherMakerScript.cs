...
namespace DigitalRuby.WeatherMaker
{
    ...
    public class WeatherMakerScript : MonoBehaviour, IWeatherMakerProvider
    {
        ...
        private void SetGlobalShaderProperties()
        {
            ...
            Shader.SetGlobalFloat(WMS._WeatherMakerFogShadowFinalStrength, 1.0f);
        ...
        private void CheckURP()
        {
            ...
            if (!UnityEditor.EditorPrefs.GetBool("WeatherMaker_AllowAutoEnableURPOnce", false))
            {
                return;
            }

            if (UnityEditor.EditorPrefs.GetBool("WeatherMaker_SuppressAutoEnableURP", false))
            {
                return;
            }
            ...
            if (guids.Length != 0)
            {
                ...
                if (asset != null)
                {
                    ...
                    UnityEditor.EditorPrefs.SetBool("WeatherMaker_AllowAutoEnableURPOnce", false);
        ...
        private void CheckPerformanceProfile()
        {
            ...
            {
                UnityEngine.QualitySettings.renderPipeline = UnityEngine.Rendering.GraphicsSettings.defaultRenderPipeline;
            }
